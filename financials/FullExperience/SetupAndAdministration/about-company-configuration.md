---
title: "About Company Configuration"
ms.custom: na
ms.date: "03-03-2017"
ms.reviewer: na
ms.suite: na
...
ms.topic: "article"
helpviewer_keywords: 
  - "RapidStart Services, company configuration overview"
ms.assetid: 9f1e3095-459c-4061-8a73-1d33fbc69e8e
...
You can provide a customer or prospective customer with an installation of FIX INCLUDE HERE<!--FIX INCLUDE HERE<!--[!INCLUDE[navnow](../ApplicationDesign/includes/navnow_md.md)] --> --> and a selection of configuration packages that can be easily accessed, deployed, modified, and applied to the current company.  

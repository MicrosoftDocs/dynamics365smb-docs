...
1. In the top right corner, choose the **Search for Page or Report** icon, enter **Account Schedules**, and then choose the related link.  
...
1. In the top right corner, choose the **Search for Page or Report** icon, enter **Account Schedule**, and then choose the related link.  

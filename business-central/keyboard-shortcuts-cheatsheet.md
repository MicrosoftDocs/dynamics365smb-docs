...
|**Quick Entry**|Ctrl+Shift+Enter<br />Enter<br />Shift+Enter|Go to next Quick Entry field outside list<br />Go to next Quick Entry field<br />Go to previous Quick Entry field|

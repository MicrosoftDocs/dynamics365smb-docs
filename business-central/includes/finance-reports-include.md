...
| [Account Schedule](https://businesscentral.dynamics.com?report=25) | Account schedules can be used to display the general ledger accounts in a different way than in the chart of accounts. For example, account schedules can be used for reports on key figures. **This is the change you want to make.**| 25 |

...
2. In the **General Ledger Setup** page, select the **Unrealized VAT** check box.
...
4. In the **VAT Posting Setup** page, choose the VAT posting group, and then choose the **Edit** action.

...
1.  In the **Data Exports** page, choose the **Record Definitions** action.  
2.  In the **Data Export Record Definitions** page, fill in the fields as described in the following table.  
...
4.  In the **Import** page, navigate to the location of the relevant DTD file, and then choose the **Open** button.  
...
2.  In the **Data Export Record Source** page, fill in the fields as described in the following table.  
    ...
    |**Table Filter**|Specify a field on which you want to set a filter.<br /><br /> In the **Table Filter** page, enter filter settings in the **Field Filter** column.<br /><br /> For example, you can specify a field that conveys information about the amount. You can also specify a date field and set a filter for it if you want to filter on a time period other than Start Date .. End Date. However, you cannot specify a date field and set a filter for it if the same field is already used in the Period Field No.|  
...
4.  In the **Data Exp. Field List** page, select one or more fields that you want to export, and then choose the **OK** button.  
...
1.  In the **Data Export Record Source** page, in the line below the line for the main table, add the related table.  
2.  Choose the **Indent** action.  
3.  Select the indented table, and then choose the **Relationships** action.  
4.  In the **Data Export Table Relation** page, fill in the fields as described in the following table.  
...
In the **Data Exp. Record Source** page, choose the **Validate** action.  

...
The following procedure describes how to set this up for vendor ledger entries in the **Purchases & Payables Setup** page. The setup is similar for customer ledger entries in the **Sales & Receivables Setup** page.

...
In FIX INCLUDE HERE<!--[!INCLUDE[navnow](../ApplicationDesign/includes/navnow_md.md)] -->, you can set up responsibility centers to help administer your business.  
...
2.  On the **Home** tab, choose **New** to create a new responsibility center. Fill in the fields. FIX INCLUDE HERE<!--[!INCLUDE[bp_fieldhelp]()] -->  

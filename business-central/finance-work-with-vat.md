...
1. On the **General Ledger Setup** window, specify a **Max. VAT Difference Allowed** between the amount calculated by the program and the manual amount.  
2. On the **Sales & Receivables Setup** window, place a check mark in the **Allow Vat Difference** field.  
...
1. On the **General Ledger Setup** window, specify a **Max. VAT Difference Allowed** between the amount calculated by the program and the manual amount.  
2. On the **General Journal Templates** window, choose the **Allow VAT Difference** check box for the relevant journal.  

#### Before you manually enter VAT on sales and purchase journals  
1. On the **Purchases & Payables Setup** window, choose the **Allow VAT Difference** check box.  
...
7. On the **Certificate of Supply** window, choose the **Print** action to print the report, or choose the **Preview** action to view it on the screen.  

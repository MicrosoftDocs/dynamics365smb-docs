...
1.  Set a dimension to be the cost object dimension in the **Update CA Dimensions** page. Only the values from this dimension are transferred.  
...
You can set up and maintain cost objects in either the **Cost Object Card** card or in the **Chart of Cost Objects** page. In this procedure, you set up cost objects in the **Chart of Cost Objects** page.  

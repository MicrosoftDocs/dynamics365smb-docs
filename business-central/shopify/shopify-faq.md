...
- B2B features, including companies, company price lists, and payment terms
  - It's currently possible to import orders created via B2B. If you have multiple buyers linked to a company, you shouldn't enable automatic creation of customers, but link each Shopify buyer to a respective customer manually.
  - You'll need to maintain company price lists in Shopify.
- Markets

...
> [!IMPORTANT]  
>  To create a proposal, you must use the **Owner Information** field in the [Vendor Bank Account Card](../Topic/\($%20N_425%20Vendor%20Bank%20Account%20Card%20$\).md) and [Customer Bank Account Card](../Topic/\($%20N_423%20Customer%20Bank%20Account%20Card%20$\).md) windows.  
...
5.  On the **Actions** tab, in the **Proposal** group, choose **Get Entries**.  
     ...
     You can use the [Get Proposal Entries Batch Job](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Netherlands/-$-b_11000000-get-proposal-entries-batch-job-$-.md) batch job to generate proposal lines based on relevant customer ledger entries.  
...
5.  On the **Actions** tab, in the **Proposal** group, choose **Get Entries**.  
     ...
     You can use the [Get Proposal Entries Batch Job](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Netherlands/-$-b_11000000-get-proposal-entries-batch-job-$-.md) batch job to generate proposal lines based on relevant vendor ledger entries.  

...
|**To**|**See**|  
|------------|-------------|  
|Create an order, adjust the prepayment amounts, and issue an invoice for prepayment amounts.|[How to: Create Prepayment Invoices](../how-to-create-prepayment-invoices.md)|  
|Issue an additional prepayment invoice, either for additional items or for an additional deposit on the original order, or issue a prepayment credit memo.|[How to: Correct Prepayments](../how-to-correct-prepayments.md)|  

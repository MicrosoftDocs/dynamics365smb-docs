...
You can choose to save the report to a file (such as Excel, Word, or PDF), print it, or only generate the report. If you choose to save the report to a file, then the processed report is sent to the **Report Inbox** page on your Role Center for you to view it. Learn more at [Share and Export Reports with the Report Inbox](ui-work-report-inbox.md)

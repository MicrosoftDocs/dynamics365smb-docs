---
    ...
    description: Payment files can be uploaded using the **IBS Logs** page. The **Upload Integration Mode** and **Download Integration Mode** fields in the **Electronic Banking Setup** page must be set to **Attended** to upload payment files.
...
Payment files can be uploaded using the **IBS Logs** page. The **Upload Integration Mode** and **Download Integration Mode** fields in the **Electronic Banking Setup** page must be set to **Attended** to upload payment files.  

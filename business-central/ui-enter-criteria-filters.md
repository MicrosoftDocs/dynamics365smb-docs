...
> [!IMPORTANT]
> If the value that you want to filter on contains a symbol that's also an operator, see [Filtering on Values That Contain Symbols](#symbols) for more instructions about handling this situation.

...
As an administrator, who has Microsoft Entra ID admin permissions, you can hide the tile by doing the following steps:

1. Sign in to the [Microsoft Entra ID admin center](https://Microsoft Entra ID.portal.azure.com/).

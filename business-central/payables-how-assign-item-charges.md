...
2. In the **Item Charges** page, choose the **New** action to create a new line.
...
9. In the **Item Charge Assignment** page, choose the **Suggest Item Charge Assignment** action.
...
2. In the **Item Charge Assignment** page, choose the **Get Receipt Lines** action.
3. In the **Purch. Receipt Lines** page, select the posted purchase receipt for the item that you want to assign the item charge to, and then choose the **OK** button.

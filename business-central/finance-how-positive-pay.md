...
6. In the **Export File** page, choose the **Save** button, and then save the file to a convenient location.
...
3. Choose the **Positive Pay Entries** action.
    ...
    In the **Positive Pay Entries** page, you can see all the Positive Pay export records for the bank account.
...
5. In the **Positive Pay Entries** page, choose the **Reexport Positive Pay to File** action.

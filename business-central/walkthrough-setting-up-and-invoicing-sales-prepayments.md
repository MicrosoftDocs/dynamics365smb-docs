...
2.  In the **Sales & Receivables Setup** page, expand the **Numbering** FastTab.  
...
1.  In the **Sales & Receivables Setup** page, on the **General** FastTab, select the **Check Prepayment when Posting** check box.
...
3.  In the **General Posting Setup Card** page, in the **Sales Prepayments Account** field, specify the relevant account.  
...
12. In the **Sales Order** page, in the **Prepayment %** field, enter **35**.  
...
1.  In the **Sales Order** page, choose the **Post Prepayment Invoice** action.  
...
1.  In the **Sales Order** page, choose the **Reopen** action.  
...
4.  In the **Apply Customer Entries** page, select the first prepayment invoice, and then choose the **Set Applies-to ID** action.  

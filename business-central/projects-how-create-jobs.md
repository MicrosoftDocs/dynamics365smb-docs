...
3. To specify the project with information on other projects, choose the **Copy Job** action, fill in the fields as necessary, and then choose the **OK** button.
...
A key part of creating a project is to specify the various tasks involved in the project. You specify tasks by creating one line per task on the **Tasks** FastTab on the **Job Card** page. Every project must have at least one task.
...
6. To specify the project tasks with information on other project tasks, choose the **Copy Job Tasks from** action, fill in the fields as necessary, and then choose the **OK** button.
...
| Type | Description |
| --- | --- |
| **Budget** |Provides estimated usage and costs for the project, typically in a time and materials type project. Planning lines of this type can't be invoiced. |
...
3. Select a project task for which the **Job Task Type** field contains **Posting**, and then choose the **Job Planning Lines** action.  

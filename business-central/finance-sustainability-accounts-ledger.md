...
>[!NOTE]
>To be familarized with scopes, based to the GHG (Greenhouse gases) standards there are three emissions scopes:  
...
To find the CoSA, select the ![Lightbulb that opens the Tell Me feature 3.](../../media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Chart of Sustainability Accounts**, and then select the related link. From the CoSA page, you can open each **Sustainability Account** and add or change settings. Hover over a field to read a short description. 
...
You can delete a **Sustainability Account**. However, before you delete it, you must be sure there are one or more ledger entries associated with this account, as Business Central will prevent you from deleting a **Sustainability Account** in this situation.  
...
To review **Sustainability Account Categories**, follow the next steps: 
...
2.	From the **Sustainability Account Categories** page, you can edit the existing list or create a new category. For creating new category, click the **New** action.  
3.	Fill in the **Code** and **Description** fields.   
4.	Set up the **Emission Scope** field, choosing one of scope options.  
5.	Select the gas emissions you want to track. Currently you can use one of options: **CO2**, **CH4**, or **N2O**. You can choose any combination you want to track, but you must have minimum one emission for tracking.  
6.	In the **Calculation Foundation** field, you can choose one of formulas you want to use in a case you do not know accurate emission amount. Here you can specify the calculation foundation (formula) for emission calculation. You can choose one of the following options: **Fuel/Electricity**, **Distance**, **Installation**, or **Custom**. 
...
If you use the **Calculation Foundation** (formulas), there is an explanation, how system will calculate based on the option you have chosen (**EF** is the **Emission Factor** you can configure in the **Sustainability Account Subcategory** page): 
...
Users need to add the **Sustainability Account Subcategory** to each of **Sustainability Accounts** to define emission factors that will be used in the formulas but based on emission tracking choice in the **Sustainability Account Category**.  

To review **Sustainability Account Subcategories**, follow the next steps:  
...
2.	From the **Sustainability Account Subcategories** page, you can edit the existing list or create a new category. For creating new category, click the **New** action.  
3.	Fill in the **Code** and **Description** fields.   
4.	Based on the gas emissions you want to track in the **Sustainability Account Category** you want to connect this subcategory with you can populate one or more emission factors: 
...
>[!NOTE]
>Fields **Import Data** and **Import From** are intended for potential integration with external systems for collecting emission factors and in **2024 release wave 1** they cannot use as a feature by default.  

## Sustainability Ledger Entries  

**Sustainability Ledger** stores the history of all posted sustainability transactions, organizing all emission data according to the **Chart of Sustainability Accounts**. When a user posts the **Sustainability Journal**, all crucial data will be recorded there. All active reports are generated based on **Sustainability Ledger Entries**.   

User can open this ledger for one specific account using the **Ledger Entries** action from the **Chart of Sustainability Account** page or, to open completely ledger, selecting the ![Lightbulb that opens the Tell Me feature 3.](../../media/ui-search/search_small.png "Tell me what you want to do") icon, entering **Sustainability Ledger Entries**, and then selecting the related link. Hover over a field to read a short description.  

>[!IMPORTNAT]
>Once when you post your data into the Sustainability Ledger, you cannot delete them. In a case you made a mistake, you can post the reverse trasaction using the same details, but with using the negative sign for amount.  

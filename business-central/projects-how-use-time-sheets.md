...
2. In the **Time Sheet List** page, choose the **Create Time Sheets** action.
...
1. Choose the ![Lightbulb that opens the Tell Me feature](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Time Sheets**, and then choose the related link.  
2. In the **Time Sheet List** page, select a time sheet for the relevant time period, and then choose the **Edit Time Sheet** action.  
...
4. In the **Time Sheet Line Job Detail** page, choose the **Work Type Code** field, and select a work type from the list, such as **Miles**.  
5. If no work types exist, chose the **New** action.
6. In the **Work Types** page, fill in the fields as necessary.

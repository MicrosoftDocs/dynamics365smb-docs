...
- **Receipt scanning** — Upload a photo or file of your receipt, and AI detects the vendor, amount, date, and category for you. You review the details and make changes if needed.
...
1. The expense moves to **Open** once details are extracted and ready for your review.
1. When you add the expense to a report, the status changes to **Pending Report**, then **Added to Report**.
1. The expense report itself moves from **Draft** → **Submitted** → **Approved** → **Paid** as it works through the approval process.

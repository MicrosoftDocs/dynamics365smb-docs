...
> [!NOTE]
> To use the Undo feature for posted bank reconciliations and bank statements, you must turn on the **Bank Recon. with Auto-Match** toggle on the **General Ledger Setup** page. It is not available for bank reconciliation worksheets.

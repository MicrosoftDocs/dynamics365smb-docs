...
You set filters in a report in more or less the same way as you set filters to delimit what is displayed on a list. For more information, see [Filtering](/business-central/ui-enter-criteria-filters.md#-filtering).

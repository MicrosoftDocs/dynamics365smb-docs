...
**Formula**  
This measure calculates the Sales Amount, where the Document Type = Quote and the Sales Opportunity No. is related to an Opportunity No.
...
### No. of Opportunities
**Formula**  
Distinct count of Opportunity No. column from the Opportunity Entries table.
...
**Formula**  
Distinct count of Opportunity No. column from the Opportunity Entries table, where Active = true and the Action Taken = Won.
...
**Formula**  
Sum of the Calculated Current Value from the Opportunity Entries table, where Active = true.
...
**Formula**  
Sum of the Estimated Value from the Opportunity Entries table, where Active = true.
...
### No. of Return Orders
**Formula**  
Distinct count of Document No. column from the Sales table where Document Type = Return Order.
...
### No. of Sales Quotes
**Formula**  
Distinct count of Document No. column from the Sales table where Document Type = Sales Quote.
...
### Return Rate
**Formula**  
This measure calculates the Sales Amount where document type is Sales Credit Memo, divided by the Sales Amount where document type is Sales Invoice.

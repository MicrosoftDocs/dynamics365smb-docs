---
title: 'How to: Reconcile Payments Using Automatic Application| Microsoft Docs'
...
A payment reconciliation journal is related to one bank account in Financials that reflects the online bank account where the payment transactions are recorded. Any open bank account ledger entries related to the applied customer or vendor ledger entries will be closed when you choose the **Post Payments and Reconcile Bank Account** action. This means that the bank account is automatically reconciled for payments that you post with the journal.

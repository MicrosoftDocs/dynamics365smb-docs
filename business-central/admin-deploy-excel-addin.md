...
|On-premises users can no longer sign in to the add-in. When they try to sign in, the process stops without completing.| This problem might be caused by a change that we made to the add-in, sometime in July 2022. For more information and a fix, see []().|

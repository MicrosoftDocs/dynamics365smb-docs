...
8.  On the **Home** tab, in the **Process** group, choose **Print** to print the pick instructions.  
  
9. After you have performed the pick, on the **Actions** tab, in the **Registering** group, choose **Register**.  

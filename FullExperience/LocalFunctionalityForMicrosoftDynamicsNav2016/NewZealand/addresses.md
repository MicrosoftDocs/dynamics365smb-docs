...
ms.topic: "article"
helpviewer_keywords: 
  - "postal codes, for New Zealand"
  - "New Zealand postal codes"
  - "Australian postal codes"
  - "postal codes, for Australia"
ms.assetid: 698bd2a7-32e8-45b0-9fd8-a7f204e7d70b
...
A single postal code can include multiple cities in the same region.  
 ...
 To enable this functionality, you must enter the data into the **\($ T\_225 Post Code $\)** table. You can do this manually, or you can download a copy of the Australian postal codes from the Australian Post Office website. Downloadable postal codes are not available for New Zealand.  

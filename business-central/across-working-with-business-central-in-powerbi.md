...
Some features are only available with Business Central online, not on-premises. For more information, see [Introduction to Business Central and Power BI](admin-powerbi.md#get-ready-to-use-power-bi)

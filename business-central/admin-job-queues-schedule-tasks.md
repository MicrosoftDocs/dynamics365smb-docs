...
When you will post sales document next time system will automatically create a job queue entry for each document and will execute them in backgorund one by one.

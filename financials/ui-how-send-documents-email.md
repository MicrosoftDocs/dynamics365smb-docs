...
6. In the **Cc:** and **Bcc:** fields, enter the email addresses of secondary recipients.
7. In the **Subject** field, enter a descriptive subject text. The default value is the customer name and invoice number.
8. In the **Attachment** field, the generated invoice is attached by default as a PDF file. Choose the lookup button to open the file or attach another one.
9. In the **Body** field, enter a short message to the recipient.
...
10. Choose the **OK** button to send the email message.

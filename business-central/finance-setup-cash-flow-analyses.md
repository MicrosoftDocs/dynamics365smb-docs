...
If you want help to decide what to do with your cash, take a look at the charts available in the Accountant Role Center:  
...
## Cash cycle and income and expense charts

The **Cash Cycle** and **Income & Expense** charts are ready to go, based on the chart of accounts (COA) and financial reports. The accounts are where the data comes from, and financial reports calculate the relationship between sales and receivables. Some accounts and financial reports are provided. You can use them as-is, change them, and add new ones. If you add general ledger (G/L) accounts to your COA, for example, by importing them from QuickBooks, you'll need to map to the accounts on the **Financial Report** page for the following row definitions:  

| Row definition | Where it's used |
| --- | --- |
...
> [!NOTE]
> It's a good idea to keep the calculations provided for the financial report.
...
To set them up, search for **cash flow accounts**, choose the link, and then fill in the fields. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)] Repeat these steps for **cash flow setup**.  

## Set up cash flow forecasts

The **Cash Flow Forecast** chart uses cash flow accounts, cash flow setups, and cash flow forecasts. Some are provided, however you can set up your own by using an assisted setup guide. The guide helps you specify conditions such as how often to update the forecast, the accounts to base it on, information about when you pay taxes, and whether to turn on [Azure AI](https://azure.microsoft.com/overview/ai-platform/).  
...
> [!NOTE]  
> Alternatively, you can use your own predictive web service. Learn more in the [Create and use your own predictive web service for cash flow forecasts](#AnchorText) section below.  
...
3. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Cash Flow Forecast**,  then choose the related link.
4. On the **Cash Flow Forecast** page, choose the **Recalculate Forecast** action.  

To use a manual process:  

1. In the Accountant Role Center, search for **cash flow setup**, then choose the related link.  
2. Expand the **Azure AI** FastTab, then choose the **Azure AI Enabled** check box.  
3. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Cash Flow Forecast**, then choose the related link.
4. On the **Cash Flow Forecast** page, choose the **Recalculate Forecast** action.  

> [!TIP]  
> Consider the length of the time periods the service uses in its calculations. The more data you provide, the more accurate the predictions are. Also, watch out for large variances in periods; that also impacts predictions. If Azure AI doesn't find enough data, or the data varies a lot, the service will not make a prediction.  

## Design details

Subscriptions for [!INCLUDE[prod_short](includes/prod_short.md)] come with access to several predictive web services in all regions where [!INCLUDE[prod_short](includes/prod_short.md)] is available. Learn more in the Microsoft Dynamics 365 Business Central Licensing Guide. The guide is available for download on the [Business Central](https://dynamics.microsoft.com/business-central/overview/) website.

These web services are stateless, meaning they use data only to calculate predictions on demand. They do not store data.

> [!NOTE]  
> You can use your own predictive web service instead of ours. Learn more at [Create and use your own predictive web service for cash flow forecasts](#AnchorText).
...
**Due Date** and **Amount (LCY)** fields on the **Customer Ledger Entries** page, where:

* The document type is *Invoice* or *Credit Memo.*
* The document date is between the date calculated based on the values in the **Historical Periods** and **Period Type** fields on the **Cash Flow Setup** page and the work date.
...
**Due Date** and **Amount (LCY)** fields on the **Vendor Ledger Entries** page, where:

* The document type is *Invoice* or *Credit Memo.*
* The due date is between the date calculated based on the values in the **Historical Periods** and **Period Type** fields on the **Cash Flow Setup** page and the work date.

Before using the predictive web service, [!INCLUDE[prod_short](includes/prod_short.md)] compresses transactions by **Due Date** based on the value in the **Period Type** field on the **Cash Flow Setup** page.

#### Tax

**Document Date** and **Amount** fields on the **VAT (Tax) Ledger Entries** page, where:
...
2. Search for **forecasting model for Microsoft Business Central**, then open the model in Azure Machine Learning Studio.  
3. Use your Microsoft account to sign up for a workspace, then copy the model.  
...
7. Expand the **Azure AI** FastTab, then fill in the fields.  

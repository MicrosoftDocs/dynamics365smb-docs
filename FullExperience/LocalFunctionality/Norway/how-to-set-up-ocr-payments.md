...
> [!NOTE]  
>  OCR payments can only be posted to cash receipt journals when the **Force Doc. Balance** field has been cleared in the **Gen. Journal Template** table. For more information, see [Gen. Journal Template](assetId:///eb60bf94-fc5b-442c-acb8-91df074d20d2).  
...
## See Also  
 ...
 [OCR Setup](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Norway/-$-t_15000100-ocr-setup-$-.md)   
 [OCR Setup](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Norway/-$-n_15000100-ocr-setup-$-.md)
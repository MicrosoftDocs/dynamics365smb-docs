...
> - You can't use **Specific User** as the **Sender type** to send emails as the specified user, as you can with BASIC auth. The reason is that OAUTH 2.0 uses the credentials of the signed in user.

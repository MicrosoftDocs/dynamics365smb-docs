...
5.  To export the file, choose the **OK** button.  
 ...
 When the file is exported, the **Reported** check box in the **Intrastat Jnl. Batches** window will be selected, and the **Internal Ref. No.** field on every entry in the journal will be filled in. You can manually change the contents of the field. For example, you can make changes when you need to run the report again. For more information, see [Intrastat Jnl. Batch](assetId:///ba164b11-d08e-472e-a56b-e03648602a9b).  
...
## See Also  
 ...
 [Intrastat Jnl. Batch](assetId:///ba164b11-d08e-472e-a56b-e03648602a9b)
...
If you use Power BI on [!INCLUDE[prod_short](includes/prod_short.md)] data, it's very easy to track KPIs or metrics that are important to you. 
...
Follow this simple four-step process to setup Power BI Metrics:

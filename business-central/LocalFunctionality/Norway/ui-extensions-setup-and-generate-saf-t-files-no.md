...
> [!NOTE]
> Starting with version 25.3, [!INCLUDE[prod_short](../../includes/prod_short.md)] in Norway supports SAF-T versions 1.20 and 1.30, as the newer version will be required in 2025. Earlier versions only support the SAF-T 1.20 format.
...
3. On the **SAF-T Export** page, choose the SAF-T version and in the **Mapping Range Code** field, choose the mapping range for which to define an export.

...
> [!NOTE]
> We're in the process of removing the features for XBRL reporting from [!INCLUDE[prod_short](includes/prod_short.md)]. For more information, see [Changes in 2022 release wave 1](/business-central/dev-itpro/upgrade/deprecated-features-w1.md#changes-in-2022-release-wave-1).

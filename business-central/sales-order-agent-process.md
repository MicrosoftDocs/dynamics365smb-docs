...
description: Learn how to use Sales Order Agent to process sales quotes and orders from customer email requests.
author: jswymer
ms.author: jswymer
ms.reviewer: jswymer
ms.topic: how-to
...
![Shows the discard step action on a sales order agent task.](media/soa-discard-step.png)
...
![Shows the resume step action on a sales order agent task.](media/soa-resume-step.png)

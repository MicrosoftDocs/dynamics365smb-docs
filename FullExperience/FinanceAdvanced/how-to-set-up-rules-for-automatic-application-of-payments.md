...
2.  In the **\($ N\_118 General Ledger Setup $\)** window, on the **Application** FastTab, fill in the **Amount Rounding Precision**, **Unit\-Amount Rounding Precision**, **Inv. Rounding Precision \(LCY\)** and **Invoice Rounding Type \(LCY\)** fields. [!INCLUDE[bp_fieldhelp]()]  

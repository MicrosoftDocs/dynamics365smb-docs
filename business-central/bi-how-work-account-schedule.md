...
To import or export financial report definitions, do as follows:
...
To import or export financial report row definitions, do as follows:
...
1. Choose the row definiiton, then choose the **Import Row Definition** or **Export Row Definition** action, depending on what you want to do.

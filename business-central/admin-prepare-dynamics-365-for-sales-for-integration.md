...
|**Automatically Synchronize Item Availability**|Specifies that item availability job queue will be scheduled. The job queue runs in every 30 minutes, and updates availability of the coupled items.|

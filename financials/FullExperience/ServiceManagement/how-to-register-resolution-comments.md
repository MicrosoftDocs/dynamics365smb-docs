...
3.  Select the line you want to register resolution comments for. Choose **Actions**![Action Menu icon](../DesignAndEngineering/media/actionmenuicon.png "actionMenuIcon"), choose **Line**, choose **Comments**, and then choose **Resolutions**. The **Resolution Service Comment Sheet** window opens.  

...
3.  Choose the **Get Cost Centers from Dimension** action to transfer dimension values to the chart of cost centers. The function transfers the dimension values that you defined in step 1.  

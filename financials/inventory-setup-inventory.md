...
|Set up multiple units of measure for an item that you can use as alternate UOMs, for example on sales, purchasing, or production transactions.|[How to: Set Up Item Units of Measure](inventory-how-setup-units-of-measure.md)|

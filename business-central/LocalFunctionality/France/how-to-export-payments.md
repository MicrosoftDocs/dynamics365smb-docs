...
2.  In the **Payment Class** page, select a payment class, and then choose the **Steps** action.  
3.  In the **Payment Step** page, fill in the **Name** field.  
4.  Choose the **Edit** action to open.  
5.  In the **Payment Step Card** page, fill in the fields.  

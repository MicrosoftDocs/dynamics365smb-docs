---
title: Accounting and bookeeping
description: Use Dynamics 365 Business Central to properly perform accounting and bookkeeping for your company.
author: altotovi
ms.topic: overview
ms.devlang: na
ms.tgt_pltfrm: na
...
Accounting is one of the critical functions in any ERP solution, as well as almost any business. Accounting represents the process of recording and cataloging a company’s financial transactions, and retrieving, measuring, summarizing, and presenting the results using different reports which are often required by local legislation. These tasks are completed with the primary goal of allowing the company’s management to understand the financials of the business and measure the results of the company’s economic activities.

As a part of the accounting process, bookkeeping is regular recording all financial transactions in a company. [!INCLUDE[prod_short](includes/prod_short.md)] is an ERP with integrated tools for easier bookkeeping inside the system, where many actions can be done automatically.

This article contains outlines for bookkeeping processes including the rules, procedures, and other guidelines in [!INCLUDE[prod_short](includes/prod_short.md)]. The content in this article intended to help accountants and bookkeepers in their daily work with this ERP system. In addition to this article, [!INCLUDE[prod_short](includes/prod_short.md)] has a context-based incorporated assistant containing links to information related to the current page and instructions on how to work with the specific process. To get this help, select the [**Help**](product-help-and-support.md) icon in the upper right corner, and the Help pane will appear. From this Help pane, you can easily find links in **About this task or page** and **Related resources from Microsoft Learn**.

The following video introduces some of the key capabilities for accounting and bookkeeping.   

> [!Video https://www.microsoft.com/videoplayer/embed/RE4Fss4?rel=0]

This table describes a sequence of tasks, with links to the articles that cover them.
...
| Specify how your customers will pay you, and how you will pay your vendors. | [Set Up Payment Methods](finance-payment-methods.md) |
...
| Specify the posting groups that map entities including customers, vendors, items, resources, and sales and purchase documents to general ledger accounts. |[Set Up Posting Groups](finance-posting-groups.md)|
...
| Set up a tolerance by which the system closes an invoice even if the payment, including any discount, doesn't fully cover the amount on the invoice. | [Work with Payment Tolerances and Payment Discount Tolerances](finance-payment-tolerance-and-payment-discount-tolerance.md) |
...
| Determine how you will handle unrealized VAT in connection with cash-based accounting methods. | [Set Up Unrealized VAT for Cash-Based Accounting](finance-setup-unrealized-vat.md) |
...
| Define one or more additional currencies so amounts are automatically reported in the local currency (LCY) and an additional reporting currency on each general ledger (G/L) entry and on other entries.| [Set Up an Additional Reporting Currency](finance-how-setup-additional-currencies.md) |
...
| Define multiple interest rates for different periods related to delayed payments in trade transactions.| [Set Up Multiple Interest Rates](finance-how-to-set-up-multiple-interest-rates.md) |
...
| Follow an end-to-end process using financial reports to make cash flow forecasts.| [Making Cash Flow Forecasts by Using Financial Reports](walkthrough-making-cash-flow-forecasts-by-using-account-schedules.md) |
...
| Create general ledger budgets to forecast different financial activities and assign dimensions for business intelligence purposes. | [Create G/L Budgets](finance-how-create-budgets.md) |
...
| Assign extra costs, such as freight and physical handling expenses you incur during trade, to the involved items. The cost is then reflected in inventory valuation. | [Use Item Charges to Account for Additional Trade Costs](payables-how-assign-item-charges.md) |
...
| Use additional currencies and update currency exchange rates automatically. | [Update Currency Exchange Rates](finance-how-update-currencies.md) |
...
| Use the Accountant Role Center, engage an external accountant, and use the Company Hub to manage the accounts of multiple clients.| [Accountant Experiences in Business Central](finance-accounting.md) |
...
| Adjust the values of fixed assets, post appreciation, and post write-down transactions. | [Revalue Fixed Assets](fa-how-revalue.md) |
| Calculate and post depreciation, and analyze depreciation in fixed assets reports. | [Depreciate or Amortize Fixed Assets](fa-how-depreciate-amortize.md) |
...
| Analyze your financial performance by setting up key performance indicators (KPIs) based on financial reports, which can then be published as web services. The published financial reports KPIs can be viewed on a web site or imported to Excel using OData web services.| [Set Up and Publish KPI Web Services Based on Financial Reports](bi-how-to-set-up-and-publish-kpi-web-services-based-on-account-schedules.md) |

...
|Make a field display only when you select **Show more**|Select the arrowhead, and choose <b>Show under "Show More"</b>. <br /> <br />If you do not see the <b>Show under "Show More"</b> option, then it is already set.||
|Make a field display always, not just when you select **Show more**.|Select the arrowhead, and choose <b>Show always</b>.||
...
|Skip over a field when pressing Enter|Select the arrowhead, and choose **Exclude from Quick Entry**|See [Accelerating Data Entry Using Quick Entry](ui-enter-data#QuickEntry)|
|Do not skip a field when pressing Enter|Select the arrowhead, and choose **Include in Quick Entry**|See [Accelerating Data Entry Using Quick Entry](ui-enter-data#QuickEntry)|

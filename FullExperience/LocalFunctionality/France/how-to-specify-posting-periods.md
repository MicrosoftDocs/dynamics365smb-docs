...
3.  In the **Allow Posting To** field, specify the end date of the posting period.  
     ...
     The dates are validated against the allowed posting ranges to make sure that they belong to open fiscal years. For more information, see [Allowed Posting Range](../../LocalFunctionalityForMicrosoftDynamicsNav2016/France/-$-n_10819-allowed-posting-range-$-.md).  
...
## See Also  
 ...
 [Allowed Posting Range](../../LocalFunctionalityForMicrosoftDynamicsNav2016/France/-$-n_10819-allowed-posting-range-$-.md)
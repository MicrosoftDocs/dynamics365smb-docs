...
When using the extended declaration, you will also need to set up an Incoterm in Intrastat Declaration for each shipping method. If you do not see the **Incoterm in Intrastat Decl.** on the **Shipment Method** window, you may need to customize the page and add the field. 

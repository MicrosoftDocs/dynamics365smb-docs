...
5. Select the **Skip If Manually Added** checkbox if you don't want to add an automatically generated digital voucher. This setting is useful if you already added a manual attachment.

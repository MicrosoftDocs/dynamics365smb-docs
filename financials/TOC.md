...
## [Using Finance and Operations, Business edition as a Power BI Data Source](across-how-use-financials-data-source-powerbi.md)
...
## [Setting Up Email](madeira-how-setup-email.md)
...
### [Use the RapidStart Services Role Center to Track Progress](admin-how-to-use-the-rapidstart-services-role-center-to-track-progress)
### [Set Up Company Configuration](admin-set-up-company-configuration)
### [Gather Customer Setup Data](admin-gather-customer-setup-values.md)
### [Use Templates to Prepare Customer Data for Migration](admin-use-templates-to-prepare-customer-data-for-migration.md)
...
### [Inviting Your External Accountant to Your Finance and Operations, Business edition](finance-invite-external-accountant.md)  
...
## [Letting Finance and Operations, Business edition Suggest Values](ui-let-system-suggest-values.md)

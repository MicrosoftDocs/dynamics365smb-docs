...
#### Warehousing
##### [Basic Location](contoso-coffee/warehousing/basic-location.md)
###### [Receiving Items with Inventory Put-Away](contoso-coffee/warehousing/basic/receiving-items-with-inventory-put-away.md)
###### [Shipping Items with Inventory Picks](contoso-coffee/warehousing/basic/shipping-items-with-inventory-picks.md)
###### [Transferring Items](contoso-coffee/warehousing/basic/transferring-items.md)
###### [Moving Items Between Bins](contoso-coffee/warehousing/basic/moving-items-between-bins.md)
###### [Adjusting Items out of Inventory](contoso-coffee/warehousing/basic/adjusting-items-out-of-inventory.md)
##### [Simple Logistics Location](contoso-coffee/warehousing/simple-logistics-location.md)
###### [Receiving a Single Order with Whse. Receipt](contoso-coffee/warehousing/simple/receiving-a-single-order-with-whse-receipt.md)
###### [Combining Orders on a Whse. Receipt](contoso-coffee/warehousing/simple/combining-orders-on-a-whse-receipt.md)
###### [Shipping a Single Order with Whse. Shipment](contoso-coffee/warehousing/simple/shipping-a-single-order-with-whse-shipment.md)
###### [Combining Orders on a Whse. Shipment](contoso-coffee/warehousing/simple/combining-orders-on-a-whse-shipment.md)
###### [Transferring Items](contoso-coffee/warehousing/simple/transferring-items.md)

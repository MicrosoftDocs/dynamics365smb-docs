...
Many of the setup tasks must be completed before you can begin recording financial transactions, but most settings can be adjusted as needed. That said, there are optional setup tasks as well. For example, you need only set-up intercompany postings and consolidations if you're working with multiple companies. And other setup tasks, such as specifying the period during which posting is allowed, might have to be repeated periodically.  
...
| Specify how you want customers to pay you, and how you want to pay your vendors. |[Set Up Payment Methods](finance-payment-methods.md) |
...
|Prepare to handle unrealized VAT with cash-based accounting methods.|[Set Up Unrealized VAT for Cash-Based Accounting](finance-setup-unrealized-vat.md)|
...
|Enable invoicing of a customer not set up in the system.|[Set Up Cash Customers](finance-how-to-set-up-cash-customers.md)|

...
|3|Basic warehouse activity, order-by-order.<br /><br /> Receive/ship posting from inventory put-away/pick documents.<br /><br /> **NOTE**:
Even though the settings are called **Require Pick** and **Require Put-away**, you can still post receipts and shipments directly from the source business documents at location where you select these check boxes. <br /><br /> Bin code is required.|Inventory Put-away/Inventory Movement/Inventory Pick, with bin code|(SILVER + Require Put-away or Require Put-away)|Basic Inventory/Bin/Put Away/Pick|  
...
For examples of how the UI documents are used per warehouse complexity level, see [Design Details: Inbound Warehouse Flow](../FullExperience/design-details-outbound-warehouse-flow.md).  

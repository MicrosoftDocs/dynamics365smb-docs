...
> [!IMPORTANT]
> If you are existing user, you need manually to change some information in the **Electronic VAT Setup** page.  

To update the electronic VAT setup for usage of new ID-porten system, please follow next steps: 
...
2. In the **Electronic VAT Setup** page in the **General** FastTab, update the following values:

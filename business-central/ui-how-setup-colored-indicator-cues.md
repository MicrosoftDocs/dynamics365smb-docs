...
You can set up Cues that appear on the **Home** window to include an indicator that changes color based on the data values in the Cues.
...
1. Under **Activities** on your **Home** window, choose **Set Up Cues**.  

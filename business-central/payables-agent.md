...
Users can inspect the agent's steps and the imported PDF invoices and suggested purchase invoice drafts. They can easily identify the data entered by the agent compared to data generated by Business Central's own business logic and provide more input if needed, such as adding discounts or updating shipping costs.

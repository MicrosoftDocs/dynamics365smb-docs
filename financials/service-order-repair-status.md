...
3. In the **Priority** field, select the priority you want for this service order status. Repeat this step for each status.  
  
## See Also  
[Understanding Service Order Status and Repair Status](service-order-repair-status.md) 
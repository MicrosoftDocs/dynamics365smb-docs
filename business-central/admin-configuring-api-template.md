...
To use templates with the API library, you must first set up and define properties for the templates. You can set up these templates in the **Configuration Templates** page. For more information, see [Prepare to Migrate Customer Data](admin-use-templates-to-prepare-customer-data-for-migration.md). 
...
The template code is the code for the template that was defined in the **Configuration Templates** page. The template values defined are applied to the API. 

...
After you have created delivery reminders, you must issue and print them so that you can send reminders to vendors. Before you issue the delivery reminders, you can print a test report. For more information, see [How to: Print Test Reports for Delivery Reminders](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Austria/how-to-print-test-reports-for-delivery-reminders.md).  
 ...
 When you issue the delivery reminders, delivery reminder ledger entries are created. You can view the created ledger entries in the **\($ N\_5005276 Deliv. Reminder Ledger Entries $\)** window.  
  
### To issue delivery reminders  
  
1.  In the **Search** box, enter **Delivery Reminder**, and then choose the related link.  
  
2.  In the **\($ N\_5005272 Delivery Reminder $\)** window, select the delivery reminder that you want to issue, and then, on the **Home** tab, in the **Manage** group, choose **Edit**.  
  
3.  On the **Actions** tab, in the **Process** group, choose **Issue**.  
  
4.  In the **\($ R\_5005341 Issue Delivery Reminder $\)** window, on the **Options** FastTab, fill in the fields as described in the following table.  
...
6.  Choose the **OK** button.  
     ...
     You can view the issued reminders in the **\($ N\_5005275 Issued Delivery Reminder $\)** window. Optionally, you can now print a delivery reminder.  
...
3.  On the **Navigate** tab, in the **Order** group, choose **\($ N\_5005276 Deliv. Reminder Ledger Entries $\)**.  
  
     In the [\($ N\_5005276 Deliv. Reminder Ledger Entries $\)](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Austria/-$-n_5005276-deliv.-reminder-ledger-entries-$-.md) window, you can view the delivery reminder ledger entries for the selected purchase order.  
...
## See Also  
 ...
 [\($ B\_5005341 Issue Delivery Reminder $\)](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Austria/-$-b_5005341-issue-delivery-reminder-$-.md)
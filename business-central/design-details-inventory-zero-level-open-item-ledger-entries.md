...
To find out whether the open item ledger entries are created, do as follows for the respective scenario:  
...
> [!NOTE]  
> Cost applications can't be identified on the **Applied Item Entries** page because that page only shows quantity applications.  
...
3. Analyze the item application entry, taking note of the following:  
   ...
   The following is an example of an item application entry.  

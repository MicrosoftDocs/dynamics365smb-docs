...
1.  For ADD INCLUDE<!--[!INCLUDE[nav_web](includes/nav_web_md.md)]-->, on the browser launch button for the web page, press Shift + Right-Click, and then choose **Run as different user**.  

...
- Set up the Business Central environment for billing Copilot and agent capabilities (preview version 26.0 sandbox environments in Austrialia, Canada, Great Britain, New Zealand, and United States only).

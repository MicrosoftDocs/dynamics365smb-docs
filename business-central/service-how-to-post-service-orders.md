...
3. In the **Service Order** page, choose one of the following actions.  
...
1. Choose the ![Lightbulb that opens the Tell Me feature](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Service Order**, and then choose the related link. 2. In the page for the selected service order, choose **Actions**, **Order**, **Service Lines**.  
3. In the **Service Lines** page, find the required entries and specify the quantity to be posted in the **Qty. to Ship** field.  
...
4. Choose **Actions**, **Posting**, **Post**. In the page that appears, choose **Ship**.  

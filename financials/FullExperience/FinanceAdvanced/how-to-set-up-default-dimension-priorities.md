...
> [!IMPORTANT]  
>  If you set up two tables with the same priority for the same source code, FIX INCLUDE HERE<!--[!INCLUDE[navnow](../ApplicationDesign/includes/navnow_md.md)] --> will always select the table with the lowest table ID.  

...
> [!NOTE]  
> Inventory Put-away is not supported for assembly process. You post assembly order to register output. If you use bins you can move items between bins later. For more information, see [Move Items Ad Hoc in Basic Warehouse Configurations](warehouse-how-to-move-items-ad-hoc-in-basic-warehousing.md).  

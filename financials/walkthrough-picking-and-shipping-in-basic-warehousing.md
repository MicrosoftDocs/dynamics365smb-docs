---
    ...
    description: In Dynamics 365, Business edition, the outbound processes for picking and shipping can be performed in four ways using different functionalities depending on the warehouse complexity level.
    author: SorenGP

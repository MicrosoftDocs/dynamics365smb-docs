...
> [!NOTE]
> Personalizing every grid control within the grid syntax is not possible . The web client currently has restrictions on designing capabilities with grid layout.

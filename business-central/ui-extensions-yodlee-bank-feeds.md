...
You can check if a bank is supported by setting up the Envestnet Yodlee Bank Feeds service and connect to the service. The bank will appear on the list if it is supported by Envestnet Yodlee.

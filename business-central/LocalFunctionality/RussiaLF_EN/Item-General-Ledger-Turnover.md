...
1. Choose the ![Search for Page or Report](../../media/ui-search/search_small.png) icon, enter **Item G/L Turnover**, and then choose the related link.
...
1. Choose the ![Search for Page or Report](../../media/ui-search/search_small.png) icon, enter **Item General Ledger Turnover**, and then choose the related link.

...
||||  
|----------------|-----------|----------------| 
|**General**|Alt+Q<br />Tab<br />Alt+Up<br />Shift+Tab<br />Alt+Down Arrow<br />Alt+Right Arrow<br />Esc|Open **Tell me**<br />Open tooltip or validation error<br />Move focus to the next control<br />Move focus to the previous control<br />Open a drop-down or look up<br />See the transactions for calculated value<br />Close the current page or drop-down.|

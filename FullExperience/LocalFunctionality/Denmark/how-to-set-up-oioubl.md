...
4.  In the **Payment Terms** window, for each payment term that you will use for electronic invoices, in the **OIOXML Code** field, select a code. For more information, see [OIOUBL Code](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Denmark/-$-t_3_13600-oioubl-code-$-.md).  
...
2.  In the **Item Charges** window, for each item charge, in the **Charge Category** field, select a category. For more information, see [Charge Category](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Denmark/-$-t_5800_13600-charge-category-$-.md).  
  
 You must also make sure that the [OIOUBL Country\-Region Code](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Denmark/-$-t_9_13600-oioubl-country-region-code-$-.md) field is filled in for Denmark in the **Countries\/Regions** window.  
...
## See Also  
 ...
 [Payment Methods](../Topic/\($%20N_427%20Payment%20Methods%20$\).md)   
 ...
 [Countries\/Regions](assetId:///bf41e72c-c814-4b75-8364-efb0136882a4)   

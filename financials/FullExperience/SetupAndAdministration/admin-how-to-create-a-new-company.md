...
To use RapidStart Services tables and pages are created, but there is no data in them.  
 ...
 Example configuration packages, including country/region-specific files, are included with the [!INCLUDE[d365fin](includes/d365fin_md.md)]. Use the following procedures to use the example configuration package with a new company.  

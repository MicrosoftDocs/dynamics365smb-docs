...
- Make sure you enter right URL into the **Shopify URL**, which you can build by combining store id from the admin URL: `admin.shopify.com/store/{shop}` with  `.myshopify.com` to get `https://{shop}.myshopify.com/`.

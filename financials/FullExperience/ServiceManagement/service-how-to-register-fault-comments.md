...
3.  Select the line you want to register fault comments for. Choose **Actions** ![Action Menu icon](../media/actionmenuicon.png "actionMenuIcon"), choose **Line** , choose **Comments**, and then choose **Faults**. The **Fault Service Comment Sheet** window opens.  

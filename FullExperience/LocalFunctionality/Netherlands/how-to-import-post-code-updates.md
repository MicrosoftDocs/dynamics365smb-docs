...
-   Is there already an update file imported with a [Date Field](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Netherlands/-$-t_11407_10-date-field-$-.md) later then the date of this new update file? If so then the process will stop.  
  
-   Is there a gap between the date of this file and the value in the [Date Field](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Netherlands/-$-t_11407_10-date-field-$-.md) field for the last imported file? If there is a gap then a message appears. You can choose if you still want to import the update file.  

...
The current requirements for sending electronic invoices are based on OIOUBL, which is based on the Universal Business Language (UBL) version 2.0 standard. For more information, see the https://aka.ms/OasisUblSite web site. The generated XML documents can then be sent to the customer.  

...
2. Select a table for which you want to modify data, and then choose the **Apply Data** action. Choose the **Yes** button to confirm the application.
...
1. Choose the ![Search for Page or Report](media/ui-search/search_small.png "Search for Page or Report icon") icon, enter **Configuration Worksheet**, and then select the related link.  
2. Select a table for which you want to modify data, and then choose the **Package Data** action.  

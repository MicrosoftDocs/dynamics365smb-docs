...
- They don't influence the planning of orders. Planning (MPS and MRP) doesn't consider and isn't affected by simulated production orders. Also, a simulated production order can't be used as a template because it disappears when you change its status.  

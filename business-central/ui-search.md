...
> [!NOTE]  
>   If you prefer to use your keyboard, use the Tab key and arrow keys to choose an item in the results. If you press **Enter** on your keyboard without choosing a result, [!INCLUDE[d365fin](includes/d365fin_md.md)] opens the result that is listed first.

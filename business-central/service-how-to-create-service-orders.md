...
4. In the **Service Lines** window, choose the item to reserve, and then choose the **Reserve** action.  
5. In the **Reservation** window, choose **Reserve from Current Line**.
...
1. Choose the ![Lightbulb that opens the Tell Me feature](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Delete Invoiced Service Orders**, and then choose the related link. The **Delete Invoiced Service Orders** batch job request window opens.  

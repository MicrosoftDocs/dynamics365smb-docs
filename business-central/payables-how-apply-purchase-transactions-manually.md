...
* By entering information in dedicated pages, such as the **Payment Journals** page and the **Payment Reconciliation Journals** page.
...
You can apply vendor payments manually to their related purchase documents when you post the payments on the **Payment Journals** page. For information about filling the payment journal, see [Making Payments](payables-make-payments.md).
...
4. Or, to apply multiple vendor ledger entries:
   ...
   4. On each line in the **Amount to Apply** field, enter the amount to apply to the individual entry.
      ...
      If you don't enter an amount, then the maximum amount is automatically applied. At the bottom of the **Apply Vendor Entries** page, you can see the amount in the Applied Amount field, and you can see whether the application balances.
...
6. Choose the **OK** button.  
   The **Purchase Credit Memos** page shows the entry that you have selected in the **Applies-to Doc. Type** field and the **Applies-to Doc. No.** field. The page also shows the amount of the credit memo to be posted, adjusted for any payment discounts.
...
7. For each line in the **Amount to Apply** field, enter the amount to apply to the individual entry.
    ...
    If you don't enter an amount, then the maximum amount is automatically applied. You can see the amount in the **Applied Amount** field at the bottom of the **Apply Vendor Entries** page.

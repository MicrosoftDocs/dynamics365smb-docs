...
2.  In the **Company Information** page, on the **General** FastTab, in the **VAT Representative** field, enter the contact person for VAT related information.  
...
5.  Choose the **Certificates** action.  
    ...
    1.  In the **Certificates** page, in the **User ID** field, specify the user who you want to authorize to submit documents to ELSTER.  
...
2.  In the **VAT Statement** page, in the **Name** field, choose the drop-down arrow.  
3.  In the **VAT Statement Names** page, in the line for the appropriate VAT statement name select the **Sales VAT Adv. Notification** field.  

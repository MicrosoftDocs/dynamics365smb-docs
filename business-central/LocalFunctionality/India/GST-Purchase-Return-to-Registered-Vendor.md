...
6. GL Entries for Intra-State/ Intra-Union Territory purchase return of goods, service, fixed asset and item charge to registered vendor where input tax credit is available, will be as following:
    ...
    |**Purchase/Service Account/Fixed Asset increase during the year**|-10000|

7. GL Entries for Intra-State/ Intra-Union Territory purchase return of goods, service, fixed asset and item charge to registered vendor where input tax credit is not available, will be as following:

    |Particulars|Amount|
    |----------------------------------|---------------------------------------|
    |**Vendor Account**|11800|
    |**Purchase/Service Account/Fixed Asset increase during the year**|-11800|
...
8. GL Entries for Inter-State purchase return of goods, services, fixed asset, charge item to registered vendor where input tax credit is available, will be as following:
    ...
    |**Purchase/Services Account/Fixed Asset increase during the year**|-10000|
...
9. GL Entries for Inter-State purchase return of goods, services, fixed asset, charge item to registered vendor where input tax credit is not available, will be as following:
    ...
    |----------------------------------|---------------------------------------|
    |**Vendor Account**|11800| 
    |**Purchase/Services Account/Fixed Asset increase during the year**|-11800|

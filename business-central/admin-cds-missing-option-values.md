...
The content of the **CDS Option Mapping** page is based on enum values in the **CRM Account** table. In [!INCLUDE[d365fin](includes/cds_long_md.md)], the following fields on the account entity are mapped to fields on the customer and vendor records:

...
||||  
|----------------|-----------|----------------|
|**General**|Alt+Q<br />Alt+Up<br />Tab/Shift+Tab<br />Alt+Down Arrow<br />Alt+Right Arrow<br />F5/Ctrl+F5<br />Esc|Open **Tell me**<br />Open tooltip or validation error<br />Move focus to the next/previous element<br />Open a drop-down or look up<br />See the transactions for calculated value<br />Refresh/reload page<br />Close the current page or drop-down.|

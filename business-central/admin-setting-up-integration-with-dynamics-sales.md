...
You must add your administrator user account for [!INCLUDE[d365fin](includes/d365fin_md.md)] as a user in [!INCLUDE[d365fin](includes/cds_long_md.md)], and then promote the user to administrator in [!INCLUDE[d365fin](includes/cds_long_md.md)]. <!--Verify this-->

...
- If the app in **Set up your Microsoft Entra accounts** is different than the app in **SharePoint Connection Setup**, the OneDrive integration will change to use the app in **Set up your Microsoft Entra accounts**.
...
- If the app in **Set up your Microsoft Entra accounts** is the same as the app in **SharePoint Connection Setup**, the OneDrive integration will use the same app as before, except from the configuration in the **Set up your Microsoft Entra accounts** setup.
...
- If there's no app configured in the **Set up your Microsoft Entra accounts** setup, the OneDrive integration will use the same app as before.

   The **OneDrive Setup** assisted setup will copy app configuration to the **Set up your Microsoft Entra accounts** setup, so it will be used for other integrations in that might set up later.

...
3.  On the **Lines** FastTab, choose **Actions**![Action Menu icon](../FullExperience/media/actionmenuicon.png "actionMenuIcon"), choose **Functions**, and then choose **Undo Return Receipt**.  
...
## See Also  
 ...
 [How to: Undo Quantity Posting on Posted Receipts](../FullExperience/how-to-undo-quantity-posting-on-posted-receipts.md)
...
|---|---|---|---|
|Analysis assist|English (en-AU, en-CA, en-GB, en-IE, en-IN, en-NZ, en-PH, en-SG, en-US, en-ZA)<br>French (fr-FR, fr-BE, fr-CA, fr-CH)<br>German (de-DE, de-AT, de-CH)<br>Spanish (es-ES, es-MX, es-CO, es-PE)<br>Chinese Simplified (zh-CN)<br>Czech (cs-CZ)<br>Danish (da-DK)<br>Dutch (nl-NL, nl-BE)<br>Finnish (fi-FI)<br>Greek (el-GR)<br>Italian (it-IT, it-CH)<br>Japanese (ja-JP)<br>Korean (ko-KR)<br>Norwegian Bokmål (nb-NO)<br>Polish (pl-PL)<br>Portuguese Brazil (pt-BR)<br>Russian (ru-RU)<br>Swedish (sv-SE)<br>Thai (th-TH)<br>Turkish (tr-TR)|Germany|[Analyze data in lists with Copilot](analysis-assist.md)|

...
|Change which UI elements are visible according to your business processes.|The **Experience** setting determines how much of the functionality is displayed in the user interface. Choose between Basic, Essential, and Premium.|All users in a specific company.|[Changing Which Features are Displayed](ui-experiences.md)|

...
---
# Power BI Integration Component and Architecture Overview for [!INCLUDE[prodshort](includes/prodshort.md)]
...
3. [!INCLUDE[prodshort](includes/prodshort.md)] verifies the license.

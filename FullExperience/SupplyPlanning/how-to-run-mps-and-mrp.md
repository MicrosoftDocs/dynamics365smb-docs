...
3.  On the **Options** FastTab, fill in the fields as described in the following table.  
    ...
    |**Respect Planning Parameters for Exception Warnings**|By default, this field is selected.<br /><br /> Supply on planning lines with warnings is normally not modified according to planning parameters. Instead, the planning system only suggests a supply to cover the exact demand quantity. However, you can define certain planning parameters for planning lines to be respected with certain warnings.<br /><br /> For more information, see [Calculate Plan \- Plan. Wksh.](../Topic/\($%20B_99001017%20Calculate%20Plan%20-%20Plan.%20Wksh.%20$\).md).|  
...
## See Also  
 ...
 [Get Action Messages](../Topic/\($%20B_99001023%20Get%20Action%20Messages%20$\).md)   

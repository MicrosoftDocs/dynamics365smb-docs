...
1.  In the **Phys. Inventory Order** page, choose the **Calculate Lines** action.  
2.  In the **Calc. Phys. Invt. Order Lines** page, on the **Options** FastTab, fill in the fields as described in the following table.  
...
1.  In the **Phys. Inventory Order** page, choose the **Copy Document** action.  
2.  In the **Copy Phys. Invt. Order** page, on the **Options** FastTab, fill in the fields as described in the following table.  

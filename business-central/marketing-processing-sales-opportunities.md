...
1. In the **Opportunity List** page, select the opportunity, and the choose the **Close** action. The **Close Opportunity** page opens.
...
1. In the **Opportunity List** page, select the opportunity, and then choose the **Assign Sales Quote** action. The **Sales Quote** page opens.
...
1. In the **Opportunity List** page, find the opportunity that you have created a sales quote for.
...
1. In the **Opportunity List** page, choose the **Update** action. The **Update Opportunity** opens,

...
> [!NOTE]
> If you work in the Safari browser, a pop-up blocker may cause the new window to not open. If this is the case, specify this URL as an allowed website: https://businesscentral.dynamics.com. For information see, [Safari: Enable/Disable Pop-up Blocker](https://go.microsoft.com/fwlink/?LinkId=2102965).  

...
6.  In the ![Shortcut icon](../BusinessFunctionality/OnlineMaps/media/shortcutcoldicon.gif "shortcutColdIcon")**[Transport Methods](DynamicsNAV:////runpage?Page=309)** window, enter the seven pre\-defined Intrastat transport methods and codes.  
...
7.  In the ![Shortcut icon](../BusinessFunctionality/OnlineMaps/media/shortcutcoldicon.gif "shortcutColdIcon")**[Item Card](DynamicsNAV:////runpage?Page=30)** window, on the **Foreign Trade** FastTab, enter the appropriate Tariff number for this item in the **Tariff No.** field.  
...
## See Also  
 ...
 [Intrastat \- Checklist](../Topic/\($%20R_502%20Intrastat%20-%20Checklist%20$\).md)   

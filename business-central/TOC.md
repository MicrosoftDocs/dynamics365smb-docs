...
### [Responsible AI FAQ for sales order taker agent](faq-sales-suggest-sales-lines-with-copilot.md)
## Sales order agent (preview)
### [Suggest lines on sales orders with Copilot](sales-order-agent.md?toc=/dynamics365/business-central/toc.json)
### [Suggest lines on sales orders with Copilot](sales-order-agent.md?toc=/dynamics365/business-central/toc.json)
### [Responsible AI FAQ for sales line suggestions with Copilot](faqs-sales-order-taker-agent.md?toc=/dynamics365/business-central/toc.json)
...
## [FAQ for sales order taker agent](faq-sales-suggest-sales-lines-with-copilot.md)

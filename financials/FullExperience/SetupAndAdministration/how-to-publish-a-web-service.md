...
Web services are a lightweight way to make application functionality available to a variety of external systems and users. In FIX INCLUDE HERE<!--FIX INCLUDE HERE<!--FIX INCLUDE HERE<!--FIX INCLUDE HERE<!--FIX INCLUDE HERE<!--[!INCLUDE[navnow](../ApplicationDesign/includes/navnow_md.md)] --> --> --> --> -->, you can expose pages, codeunits, and queries as web services. When you publish [!INCLUDE[navnow](../ApplicationDesign/includes/navnow_md.md)] objects as web services, they are immediately available on the network.  
  
 You can set up a web service in the FIX INCLUDE HERE<!--FIX INCLUDE HERE<!--FIX INCLUDE HERE<!--[!INCLUDE[nav_windows](../BusinessFunctionality/IntegratingWithMicrosoftOffice/includes/nav_windows_md.md)] --> --> --> or the FIX INCLUDE HERE<!--FIX INCLUDE HERE<!--FIX INCLUDE HERE<!--[!INCLUDE[nav_web](../BusinessFunctionality/IntegratingWithMicrosoftDynamicsCRM/includes/nav_web_md.md)] --> --> -->. You must then publish the web service so that it is available to service requests over the network. Users can discover web services by pointing a browser at the computer that is running FIX INCLUDE HERE<!--FIX INCLUDE HERE<!--FIX INCLUDE HERE<!--[!INCLUDE[nav_server](../BusinessFunctionality/IntegratingWithMicrosoftOffice/includes/nav_server_md.md)] --> --> --> and requesting a list of available services. When you publish a web service, it is immediately available over the network for authenticated users. All authorized users can access metadata for [!INCLUDE[navnow](../ApplicationDesign/includes/navnow_md.md)] web services, but only users who have sufficient [!INCLUDE[navnow](../ApplicationDesign/includes/navnow_md.md)] permissions can access actual data.  
...
1.  In your browser, enter the relevant URL. The following table illustrates the types of URLs that you can enter. For SOAP web services, use the following format for your URI.  
    ...
    |----------------------|------------|-------------|  
    |SOAP|https:\/\/*Server*:*SOAPWebServicePort*\/*ServerInstance*\/WS\/*CompanyName*\/services\/|https:\/\/localhost:7047\/FIX INCLUDE HERE<!--FIX INCLUDE HERE<!--[!INCLUDE[nav_server_instance](../SetupAndAdministration/includes/nav_server_instance_md.md)] --> -->\/WS\/CRONUS International Ltd.\/services\/|  

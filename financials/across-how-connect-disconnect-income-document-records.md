---
title: How to: Create Incoming Document Records Directly from Documents and Entries| Microsoft Docs
description: You can attach incoming documents from an external source to entries in Financials, so you can look up the original if needed.
...
---
# How to: Create and Connect Incoming Document Records From Documents and Entries

...
3. In the **General** section, in the **No.** field, enter a number for the segment.
    ...
    Alternatively, if you have set up number series for segments in the **Marketing Setup** page, you can press Enter to select the next available segment number.

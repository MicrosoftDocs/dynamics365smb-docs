...
- Клиент - Акт Выверки Упрощенный (отчет 50176)
...
Выберите значок ![Поиск страницы или отчета](), введите **Оборотная ведомость по клиентам**, а затем выберите связанную ссылку.
...
Выберите значок ![Поиск страницы или отчета](), введите **Оборот по учетной группе клиентов**, а затем выберите связанную ссылку.
...
Выберите значок ![Поиск страницы или отчета](), введите **Анализ операций клиента**, а затем выберите связанную ссылку.
...
Выберите значок ![Поиск страницы или отчета](), введите **Клиент - акт выверки упрощенный**, а затем выберите связанную ссылку.

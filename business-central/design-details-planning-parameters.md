...
> [!NOTE]
> With reordering policy Lot-for-Lot, **Lot Accumulation Period** must be equal or larger than **Dampener Period**. Otherwise **Dampener Period** will be automatically reduced during planning routine to match **Lot Accumulation Period**.  

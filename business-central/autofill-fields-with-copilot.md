...
The autofill feature is available on card and document pages, like a **Customer card** or a **Sales Order**, and only on editable fields within FastTabs on these pages, except those fields listed in the following section.

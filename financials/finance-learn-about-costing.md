...
|Learn how an item's unit cost is continuously updated with the cost of its latest transaction according to the item's costing method.|[How to: Adjust Item Costs](inventory-how-adjust-item-costs.md)|  

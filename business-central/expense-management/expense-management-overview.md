...
For travel expenses, the module supports *per diem* allowances and *mileage* reimbursement. Administrators configure rates, calculation methods, and partial-day rules in the setup. Learn more at [Set up per diem and mileage allowances](expense-management-per-diem-mileage.md).

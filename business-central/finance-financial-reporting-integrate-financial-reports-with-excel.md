...
> [!TIP]
> The **Row No.** field shows on the data worksheet, but you might not want to include it on your worksheet.
...
My report should show in additional worksheets. 
It's OK to add multiple worksheets for different types of analysis.

I want the report be formatted professionally with headers in bold, and amounts formatted as currency (rounded to nearest integer). 
...
1. Upload your Excel template (close the Excel workbook before you upload it).
1. On the **Name/Value Lookup** page, choose the Data worksheet.

   [!INCLUDE[prod_short](includes/prod_short.md)] runs the financial report and merges the resulting data with your Excel template.
...
To produce your monthly financial report, follow these steps:
...
1. The next screen shows the worksheets/tabs that are available in the Excel workbook. Choose the **Data** tab, and then choose **OK**. 

   > [!NOTE]
   > If you choose the tab labeled **IS**, your formatting is overwritten and you need to start over.
...
1. To download the Excel template, choose the **Run/Export** action.
...
Microsoft maintains this article. The following contributors provided parts of the examples.

...
3.  On the **General** FastTab, select the **No Stockkeeping** check box.  
     ...
     An item ledger entry will not be created when you post a transaction for this item. For more information, see the [Item Ledger Entry](../Topic/\($%20T_32%20Item%20Ledger%20Entry%20$\).md) table.  

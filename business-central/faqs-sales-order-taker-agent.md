...
- Emailing
  ...
  - The agent processes the email body and any PDF or image files attached to emails to get the details of the request. PDF attachments must be 5 MB or smaller and contain a maximum of 10 pages.

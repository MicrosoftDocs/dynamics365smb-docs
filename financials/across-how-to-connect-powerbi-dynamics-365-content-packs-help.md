...
3. Select **Apps** from the **Apps for Power BI apps** tab, and choose the **Finance and Operations, Business edition** content pack that you want to use, and then select **Get it now**.  

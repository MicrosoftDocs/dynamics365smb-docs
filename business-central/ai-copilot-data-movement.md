...
> [!IMPORTANT]
> The **Allow data movement** toggle switch is on by default from version 25.0. Administrators can opt out at any time, even before environments are upgraded. Environments upgrading to version 25.0 or later have the **Allow data movement** switch enabled from 3 November 2024, or from the date you have specified for the environment to be upgraded to version 25.0. New environments created after 1 October 2024 will have the Allow data movement switch on. 

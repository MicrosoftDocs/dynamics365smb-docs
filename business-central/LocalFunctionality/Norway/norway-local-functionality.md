...
[Print a VAT Reconciliation Report](how-to-print-a-vat-reconciliation-report.md)  
...
[Set Up Document Printing](how-to-set-up-document-printing.md)  
...
[Types of Payment Return Files](types-of-payment-returns-files.md)  
[Payroll Data Definitions](ui-extensions-payroll-data-definitions-no.md)  
<!--
  [Apply General Ledger Entries in Closed Periods](how-to-apply-general-ledger-entries-in-closed-periods.md)  

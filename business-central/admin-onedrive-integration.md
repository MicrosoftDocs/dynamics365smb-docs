...
### Prepare [!INCLUDE[prod_short](includes/prod_short.md)] on-premises for connecting to OneDrive
...
### Set up the connection in [!INCLUDE[prod_short](includes/prod_short.md)] on-premises

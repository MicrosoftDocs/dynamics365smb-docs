...
> [!TIP]
> For a quick, print-friendly overview of the most used general UI functions, choose the following two image:
>
> [ ![To download for printing, right-click and select Save image as](media/megacheatsheet_1_inline.png) ](media/megacheatsheet_1_inline.png#lightbox)
>
> [ ![To download for printing, right-click and select Save image as](media/megacheatsheet_2_inline.png) ](media/megacheatsheet_2_inline.png#lightbox)

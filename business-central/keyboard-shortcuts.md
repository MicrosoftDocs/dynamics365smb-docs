...
|<kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>Down Arrow</kbd><br /><br />(<kbd>Ctrl</kbd>+<kbd>Option</kbd>+<kbd>Down Arrow</kbd>)|Open a related record's card or list page filtered to the value in the lookup or assist edit field.|

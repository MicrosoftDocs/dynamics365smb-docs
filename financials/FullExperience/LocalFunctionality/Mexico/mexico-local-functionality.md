...
ms.assetid: befbdc95-e1c3-422c-88fe-7cfce50922cd
...
The following topics describe the local functionality in the Mexican version of ADD INCLUDE<!--[!INCLUDE[navnow](../../ApplicationDesign/includes/navnow_md.md)]-->.  

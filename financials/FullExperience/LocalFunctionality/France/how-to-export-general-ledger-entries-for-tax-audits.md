...
3.  Choose the **OK** button to export the file.  
     ...
     When you create the report, ADD INCLUDE<!--[!INCLUDE[navnow](../../includes/navnow_md.md)]--> sorts the information in the report by the **No.** and **Creation Date** fields in the general ledger register.  

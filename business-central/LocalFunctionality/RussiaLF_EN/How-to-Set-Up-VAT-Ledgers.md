...
3. Choose the ![Search for Page or Report]() icon, enter **Vendor Posting Groups**, and then choose the related link.
...
5. Choose the ![Search for Page or Report]() icon, enter **VAT Posting Setup**, and then choose the related link.

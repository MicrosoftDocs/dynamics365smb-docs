...
3.  In the **Customer Card** window, on the **General** FastTab, in the **Post Code** field, select the post code for the customer's address.  
    ...
    > [!NOTE]  
    >  When you select the post code, the **City** and **Country\/Region Code** fields populate automatically with the information from the **Post Code** table. For more information, see [How to: Register New Customers](../../Sales/how-to-register-new-customers.md).  
  
4.  Choose the **OK** button.  
  
## See Also  
 [Import Post Codes](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Switzerland/-$-b_11502-import-post-codes-$-.md)   
 ...
 [Post Code](assetId:///e8d7052c-625d-4e75-ba6b-a6a25bada890)   

...
ms.topic: how-to
ms.devlang: al
ms.search.keywords: service price management, service price groups, service pricing, service price adjustment
ms.date: 10/03/2025
ms.author: bholtorf
...
The service price adjustment function doesn't apply to service items under the following conditions:
...
|Option | Description |  
|----------------------------------|---------------------------------------|  
|**Fixed Price**|This means that you charge a fixed price for the service item, resource, general ledger account, or cost, regardless of the real costs or regular charges. Selecting this option means that the service price adjustment reaches the exact amount specified in the service price group.|  

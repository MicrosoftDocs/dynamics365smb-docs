...
1.  Open the consolidated company. For more information, see [How to: Select a Company](../company-how-to-select-a-company.md)  

2.  In the **Search** box, enter **Business Units**, and then choose the related link.Open the **Business Units** window.  

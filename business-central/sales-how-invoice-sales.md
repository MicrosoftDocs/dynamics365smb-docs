...
2. In the **Customer** field, enter the name of an existing customer.
   ...
   Other fields in the **Sales Invoice** page contain standard information about the selected customer. If the customer is not registered, follow these steps:
...
8. Fill in the remaining fields in the **Sales Invoice** page as necessary. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]

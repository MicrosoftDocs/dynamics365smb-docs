...
1. Choose the ![Search for Page or Report]() icon, enter **Tax Register Setup**, and then choose the related link.
...
For more information about how to set up and customize tax registers, see [How to: Create Tax Registers]().

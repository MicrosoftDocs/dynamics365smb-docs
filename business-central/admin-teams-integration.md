...
> [!NOTE]
> To set up Centralized Deployment, your Teams account must have at least the [Teams Service admin](/entra/identity/role-based-access-control/permissions-reference#teams-administrator] role.

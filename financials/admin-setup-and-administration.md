...
|Track all direct modifications that users make to data in the database to identify the origin of errors and data changes.
|[Logging Changes in Dynamics 365 for Financials](across-log-changes.md)|  
...
|Set up an SMTP server to enable e-mail communication in and out of [How to: Set Up Email Manually or Using the Assisted Setup](madeira-how-setup-email.md)|  

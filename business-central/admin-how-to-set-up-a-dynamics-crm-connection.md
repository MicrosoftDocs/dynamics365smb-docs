...
Starting in 2020 release wave 1, you can use match-based coupling of records in [!INCLUDE [prod_short](includes/prod_short.md)] and [!INCLUDE [cds_long_md](includes/cds_long_md.md)], based on matching criteria defined by the administrator.  

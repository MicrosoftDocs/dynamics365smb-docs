...
> [!NOTE]
> If you work in the Safari browser, a pop-up blocker may cause the new window to not open. If this is the case, specify the product URL as an allowed website. For information see, [Change Websites Preferences in Safari on Mac](https://go.microsoft.com/fwlink/?LinkId=2102965).  

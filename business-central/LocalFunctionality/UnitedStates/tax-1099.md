...
In [!INCLUDE[d365fin](../../includes/d365fin_md.md)], new 1099 Form Box codes *NEC-01* and *MISC-14* and a new form, *Vendor 1099 Nec*, has been added. The additions are relevant for the reporting year 2019 and before you make the reporting for 2019 you must first perform an upgrade to handle the new requirements. In this case upgrade means you must run the action **Update Form Boxes** on the **1099 Form-Boxes** page. Note, that doing so will make reporing for 2018 impossible, since some boxes change meaning. Please make sure that all reporting for 2018 has been made before you update the form boxes, which will prepare your system for reporting for 2019.

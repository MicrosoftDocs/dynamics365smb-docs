...
You must then list the users and the friendly names of the certificates on the **Certificates** page. For more information about how to install a certificate and how to find the friendly name, see the Help for the operating system.  

If you use a proxy server to submit the ELSTER documents, you must specify the settings on the **Electronic VAT Decl. Setup** page.  

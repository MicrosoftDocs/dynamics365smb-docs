...
|Payments outside the legal limit|The amounts in LCY and the percentage of the total payments that were made after the maximum allowed due date for each transaction.|  
 ...
 At the end of these reports, there is a section that summarizes this information for all payments. These reports will show information based on applied detailed customer ledger entries or applied detailed vendor ledger entries. The information is based on the date filters that you specify. For more information, see [Customer \- Overdue Payments](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Spain/-$-r_10747-customer-overdue-payments-$-.md) and [Vendor \- Overdue Payments](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Spain/-$-r_10748-vendor-overdue-payments-$-.md).  
...
## See Also  
 ...
 [Customer \- Overdue Payments](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Spain/-$-r_10747-customer-overdue-payments-$-.md)   
 [Vendor \- Overdue Payments](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Spain/-$-r_10748-vendor-overdue-payments-$-.md)
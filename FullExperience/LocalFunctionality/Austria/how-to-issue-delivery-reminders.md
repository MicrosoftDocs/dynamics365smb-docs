...
3.  On the **Navigate** tab, in the **Order** group, choose **Deliv. Reminder Ledger Entries**.  
     ...
     In the [Deliv. Reminder Ledger Entries](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Austria/-$-n_5005276-deliv.-reminder-ledger-entries-$-.md) window, you can view the delivery reminder ledger entries for the selected purchase order.  
...
## See Also  
 ...
 [Issue Delivery Reminder](../../LocalFunctionalityForMicrosoftDynamicsNav2016/Austria/-$-b_5005341-issue-delivery-reminder-$-.md)
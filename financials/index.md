...
For more information, see [Working With [!INCLUDE[d365fin_long](includes/d365fin_long_md.md)]](ui-work-product.md).  

When you're ready to do some heavier lifting, and want to look at some of the business processes that [!INCLUDE[d365fin](includes/d365fin_md.md)] supports, see [Business Functionality](madeira-business-functionality.md).  
...
[Using [!INCLUDE[d365fin_long](includes/d365fin_long_md.md)] as my Business Inbox in Outlook](madeira-outlook.md)  

...
This article provides an overview of how to set up the user accounts that are required to integrate Common Data Service with [!INCLUDE[d365fin](includes/d365fin_md.md)].  

> [!VIDEO https://go.microsoft.com/fwlink/?linkid=2085500]

## Setting Up the Administrator User Account
You must add your administrator user account for [!INCLUDE[d365fin](includes/d365fin_md.md)] as a user in Common Data Service, and then promote the user to administrator in Common Data Service. <!--Verify this-->

## Setting Up the User Account for the Integration
You must create a dedicated user account in your Office 365 subscription that both [!INCLUDE[d365fin](includes/d365fin_md.md)] and Common Data Service can use to synchronize data. This user account must be able to sign in to Common Data Service, which means this user must have a license for Common Data Service and at least one security role assigned to it in Common Data Service <!--not sure that this applies as described [here](/dynamics365/customer-engagement/admin/create-users-assign-online-security-roles#create-a-user-account). For more information about how to create users in Common Data Service, see [Manage security, users, and teams](https://go.microsoft.com/fwlink/?LinkID=616518). --> After the connection is set up, [!INCLUDE[d365fin](includes/d365fin_md.md)] will assign the user account the security roles that it needs in [!INCLUDE[d365fin](includes/d365fin_md.md)].

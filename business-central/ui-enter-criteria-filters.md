...
The key difference is that legacy search only finds records with the exact words in the order you type them, while modern search finds records words in any order.

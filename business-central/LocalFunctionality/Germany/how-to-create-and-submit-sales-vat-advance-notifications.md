...
2.  In the **Sales Vat Advanced Notification List** page, choose the **New** action.  
3.  In the **Sales VAT Adv. Notif. Card** page, fill in the fields as described in the following table.  
...
1.  In the **Sales VAT Advance Notification List** page, select the document that you want to submit to ELSTER.  

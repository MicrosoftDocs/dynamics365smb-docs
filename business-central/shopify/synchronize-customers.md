...
|**Shopify Can Update Customers**| Select if you want the system to update customers founded, when  **By Email/Phone** or **By Bill-To Info** options are selected in the **Customer Mapping Type** field.| 

...
-   Item cards are created for parent items and their components. For more information, see [How to: Register New Products](../FullExperience/how-to-register-new-products.md).  
...
8.  You can now attach the new production BOM to the card of the parent item in question. For more information, see [How to: Register New Products](../FullExperience/how-to-register-new-products.md).  
...
## See Also  
 [Define Material and Process Structure](../FullExperience/define-material-and-process-structure.md)   

---
title: "How to: Add or Remove Filter Panes and FactBox Panes"
ms.custom: na
ms.date: "03-03-2017"
ms.reviewer: na
ms.suite: na
...
helpviewer_keywords: 
  - "panes, deleting"
  - "panes, adding"
ms.assetid: bdd5bad2-2ddc-4182-8861-81046a207e96
...
In FIX INCLUDE HERE<!--[!INCLUDE[navnow](../ApplicationDesign/includes/navnow_md.md)] --> you can select among different panes. These panes give you easy access to related information. Some panes can be added or removed directly in the **Customize** window, which opens when you select **Customize** from the Application menu. Some panes such as the Filter Pane, the ribbon, and the FactBox pane can also be added or removed by using the **Customize** dialog box. Panes on the Role Center can only be removed by using the **Customize** dialog box.  

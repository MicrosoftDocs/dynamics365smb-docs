...
### Automatically created [!INCLUDE[d365fin](includes/d365fin_md.md)] Integration application user
During connection to [!INCLUDE[d365fin](includes/cds_long_md.md)], administrator will be asked to grant consent to registered Azure Application called [!INCLUDE[d365fin](includes/d365fin_md.md)] Integration to [!INCLUDE[d365fin](includes/cds_long_md.md)] to create  [!INCLUDE[d365fin](includes/d365fin_md.md)] Integration application user, assign roles to that user and to run synchronization of data between [!INCLUDE[d365fin](includes/d365fin_md.md)] and [!INCLUDE[d365fin](includes/cds_long_md.md)] on behalf of automatically created [!INCLUDE[d365fin](includes/d365fin_md.md)] Integration application user.  

<!-- No need to setup integration user starting from 16.2 
...
<!--After the connection is set up, [!INCLUDE[d365fin](includes/d365fin_md.md)] will assign the user account the security roles that it needs in [!INCLUDE[d365fin](includes/d365fin_md.md)]. -->

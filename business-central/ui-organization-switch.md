...
When you are signed-in to [!INCLUDE[d365fin](includes/d365fin_md.md)], the environments that you can access are available on the Dynamics 365 Home page. You can open the page by choosing the **App Picker** icon :::image type="content" source="media/app-launcher-icon.PNG" alt-text=""::: in the upper left and choosing **Dynamics 365**. To go to your default company in that environment, click the tile.

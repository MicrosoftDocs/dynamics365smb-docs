...
## Creating Finance Charges  
 ...
 If no multiple interest rates exist, [!INCLUDE[navnow](../../ApplicationDesign/includes/navnow_md.md)] will use the interest rate and period that is defined in the **Finance Charge Terms** window for the whole period of calculation.  

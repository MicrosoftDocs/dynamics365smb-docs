...
In some cases, the add-ins do not get added automatically to Outlook. Even if you or a colleague ran the assisted setup guide on behalf of the company, Financials might not show up in Outlook. If you experience this issue, you can add the Financials add-ins manually.  

First, you must verify that you have access to the add-ins in your Office 365 account. Quite simply open your Outlook Web Access in a browser, and then add `/owa/#path=/options/manageapps` to the URL in the address bar. This opens the **Manage add-ins** page, where you can enable Financials for your Outlook. Then, when you navigate back to Outlook, Financials should be available.  

Similarly in the Outlook desktop client, you can verify that Financials is listed in the **Manage Add-ins** window.  

In both cases, if Financials is still not available, you have to get the add-in manifest files. For more information, please contact your Office 365 administrator.

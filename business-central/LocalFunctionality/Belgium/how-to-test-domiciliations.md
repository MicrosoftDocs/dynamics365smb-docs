---
    title: How to Test Domiciliations [BE]
    description: To test the domiciliation journal lines, you can use the Domiciliation Journal - Test report to print the report.
...
---
# Test Domiciliations in the Belgian Version

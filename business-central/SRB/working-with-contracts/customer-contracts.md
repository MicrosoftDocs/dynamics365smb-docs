...
When the subscription lines are in a contract transfer, contract lines are created with the content of the subscription lines. Changes to contract lines transfer to the subscription lines. The **Quantity** field displays the quantity of the related subscription.

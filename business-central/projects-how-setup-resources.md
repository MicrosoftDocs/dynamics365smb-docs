...
1. [!INCLUDE[open-search](includes/open-search.md)], enter **Resource groups**, and then choose the related link.
2. Choose the **New** action.
...
1. [!INCLUDE[open-search](includes/open-search.md)], enter **Adjust Resource Costs/Prices**, and then choose the related link.
...
1. [!INCLUDE[open-search](includes/open-search.md)], enter **Resource Price Changes**, and then choose the related link.

...
* The **EC Sales List** European Community (EC) Sales List report lists the value added tax (VAT) amounts that you have collected for sales within the European Union (EU).
* The **VAT Return** report includes VAT for sales and purchases. <!-- is this within and outside the EU? -->

<!-- Is the EC Sales List report exclusive to the UK? --> 

## About the EC Sales List report
In the UK, all companies that sell more than a certain value to customers in EU member states must submit an electronic version of their European Community (EC) sales list report in XML format through Her Majesty's Revenue and Customs (HMRC) website. The EC Sales List report works only for countries in the EU. For example, it does not include VAT on sales to countries like the United States or China.

...
To learn more, go to [Refresh [!INCLUDE [powerbi-name](includes/powerbi-name.md)] semantic models](https://learn.microsoft.com/dynamics365/business-central/across-working-with-powerbi#work-with-power-bi-reports).

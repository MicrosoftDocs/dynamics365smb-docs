...
1. In the top right corner, choose the **Search for Page or Report** icon, enter **Sales Column Templates**, and then choose the related link.  
...
1. In the top right corner, choose the **Search for Page or Report** icon, enter **Sales Line Templates**, and then choose the related link.  
2. Select the first empty line, and then fill in the fields as necessary.
...
1. In the top right corner, choose the **Search for Page or Report** icon, enter **Sales Analysis Reports**, and then choose the related link.  

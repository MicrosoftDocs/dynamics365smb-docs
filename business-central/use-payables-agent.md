...
Fields that are recommended for review will display an [info] information icon. 
...
Important: Fields recommended for review are provided as a convenience and you are not required to inspect all of them. You should always review the entire purchase document draft, especially if you are new to the Payables Agent and are in the process of learning the limitations of how the agent works with your data. 

Note: while reviewing a purchase document draft, you cannot use Copilot’s Autofill feature. 

...
ms.topic: "article"
helpviewer_keywords: 
  - "warehouse, outbound flow"
ms.assetid: 9b03f6ce-4b98-49b5-b31f-6dc8cb08dea5
...
2.  Assembly order with component need  
 ...
 The last two documents represent outbound flows from the warehouse to internal operation areas. For more information about warehouse handling for internal inbound and outbound processes, see [Design Details: Internal Warehouse Flows](../ApplicationDesign/design-details-internal-warehouse-flows.md).  
 ...
 In ADD INCLUDE<!--[!INCLUDE[dyn_nav](../ApplicationDesign/includes/dyn_nav_md.md)]-->, the outbound processes of picking and shipping can be performed in four ways using different functionalities depending on the warehouse complexity level.  
...
## Basic Warehousing  
 ...
 ![Outbound flow in basic warehousing](../ApplicationDesign/media/design_details_warehouse_management_outbound_basic_flow.png "design\_details\_warehouse\_management\_outbound\_basic\_flow")  
...
## Advanced Warehousing  
 ...
 ![Outbound flow in advanced warehousing](../ApplicationDesign/media/design_details_warehouse_management_outbound_advanced_flow.png "design\_details\_warehouse\_management\_outbound\_advanced\_flow")  
